...
public class CitySceneState : SceneState
{
    ...
    public CitySceneState(int id, string unitySceneName, SceneState nextScene, int roundTime, CharacterAttributes.SpawnRestrictions spawnRestrictions, LevelType levelType, string textSceneName, TextSceneData losingTextScene) : base(id, unitySceneName, nextScene)
    {
